...
/**
 * Onboarding progress, stored on the account rather than on this device.
 *
...
/** Mock/preview mode has no server, and an offline UI session should simply see no tours. */
