import { getRentForMonth, getScheduleEndDate, type Renter, type Transaction } from '@/src/shared/types';
 ...
 * (`rent-control-web/src/features/transactions/utils/rentSchedule.ts`).
 */
