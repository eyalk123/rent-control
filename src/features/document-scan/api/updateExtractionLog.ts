...
/** Diff submitted form values against what we prefilled. A field is "given" only if we
 *  filled it with a non-empty value, and "changed" only if the user altered that value —
 *  filling a field we left blank is neither. */
